...
class _$RoleImpl implements _Role {
  const _$RoleImpl({required this.name, required this.address});
  ...
  @override
  String toString() {
    return 'Role(name: $name, address: $address)';
  }
...
abstract class _Role implements Role {
  const factory _Role(
      {required final String name, required final String address}) = _$RoleImpl;
