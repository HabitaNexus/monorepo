...
abstract class $MilestoneCopyWith<$Res> {
  ...
  @useResult
  $Res call({String description, String status, bool approvedFlag});
}
...
class _$MilestoneImpl implements _Milestone {
  ...
  @override
  String toString() {
    return 'Milestone(description: $description, status: $status, approvedFlag: $approvedFlag)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, description, status, approvedFlag);
...
abstract class _Milestone implements Milestone {
  const factory _Milestone(
      ...
      final String status,
      final bool approvedFlag}) = _$MilestoneImpl;
