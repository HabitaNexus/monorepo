...
abstract class $FlagsCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool approved, bool disputed, bool released});
}
...
class _$FlagsImpl implements _Flags {
  const _$FlagsImpl(
      {this.approved = false, this.disputed = false, this.released = false});
  ...
  @override
  String toString() {
    return 'Flags(approved: $approved, disputed: $disputed, released: $released)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, approved, disputed, released);
...
abstract class _Flags implements Flags {
  const factory _Flags(
      {final bool approved,
      final bool disputed,
      final bool released}) = _$FlagsImpl;
